...
export const AddNewStudentModal = ({ setModalOpen, madrasaId }: any) => {
  ...
  const initialValues = {
    ...
    grade: '',
    TshirtSize: '',
    activity: '', // New field for activity
  };

  // List of activities
  const activities = ['Sports', 'Music', 'Art', 'Science Club'];
            ...
            {({ isSubmitting }) => (
              <Form className="space-y-4">
                ...
                <div>
                  ...
                  />
                  <ErrorMessage name="studentName" component="div" className="text-red-600 text-sm mt-1" />
                </div>
                  ...
                  <Field
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <ErrorMessage name="FatherName" component="div" className="text-red-600 text-sm mt-1" />
                </div>
                ...
                <div>
                  ...
                  <Field
                    ...
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                  <ErrorMessage name="TshirtSize" component="div" className="text-red-600 text-sm mt-1" />
                </div>
                ...
                <div>
                  ...
                  <ErrorMessage name="activity" component="div" className="text-red-600 text-sm mt-1" />
                </div>
                ...
                <div className="flex justify-between items-center">
                  <button
                    ...
                    className={`${isSubmitting ? 'bg-gray-400' : 'bg-blue-500 hover:bg-blue-600'} text-white font-semibold py-2 px-4 rounded-lg transition-colors duration-200`}
                  >
